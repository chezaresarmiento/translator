...
<template>
  ...
  <AuthenticatedLayout>
    <template #header>
      <h2 class="text-xl font-semibold leading-tight text-gray-100 dark:text-gray-100">
        Dashboard
      </h2>
    </template>
    ...
    <div
      class="py-12 bg-gray-50 dark:bg-gray-900 transition-colors duration-300 min-h-screen"
    >
            ...
            <div>
              ...
              <div class="flex items-center justify-between">
                <div>
                  <button
                    ...
                    class="rounded-full bg-gray-200 px-4 py-2 text-black transition-colors duration-300 hover:bg-gray-300 dark:bg-zinc-700 dark:text-white dark:hover:bg-zinc-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500"
                  >
                    🎤 Hold to Speak
                  </button>
                </div>
                ...
                <div>
                  <div v-if="isRecording" class="flex items-center space-x-2">
                    <div class="relative flex">
                      ...
                      <div
                        class="absolute h-full w-full rounded-full bg-red-300 opacity-75 animate-ping"
                      ></div>
                      <!-- Center icon -->
                      <div
                        class="relative flex h-12 w-12 items-center justify-center rounded-full bg-red-500 text-white"
                      >
                        🎤
                      </div>
                    </div>
                ...
                <div>
                  ...
                  <div v-if="isTranslating" class="flex items-center space-x-2">
                    ...
                    <div class="relative flex">
                      <!-- Expanding ring (the ping) -->
                      <div
                        class="absolute h-full w-full rounded-full bg-green-300 opacity-75 animate-ping"
                      ></div>
                      <!-- Center icon -->
                      <div
                        class="relative flex h-8 w-8 items-center justify-center rounded-full bg-green-500 text-white"
                      >
                        🌐
                      </div>
                    </div>
              ...
              <ul class="mt-4 space-y-2">
                ...
                >
                  ...
                  <span v-else>
                    <b>[{{ formatTimestamp(msg.timestamp) }}] {{ msg.speaker }}:</b>
                    {{ msg.text }}
                  </span>
                </li>
              </ul>
...
export default {
  ...
  mounted() {
    ...
    window.Echo.private(`translations.${this.userId}`).listen(
